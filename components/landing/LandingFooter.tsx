...
export function LandingFooter() {
  return (
    <footer className="bg-[#081019] text-slate-300">
      <div className="mx-auto max-w-7xl px-[var(--page-gutter)] pb-10 pt-20 sm:pt-28">
        <div className="grid gap-12 border-b border-white/10 pb-16 sm:grid-cols-2 lg:grid-cols-[1.4fr_0.7fr_0.7fr_1fr] lg:gap-10">
          <div className="max-w-sm">
            <Link href="/" className="inline-flex items-center gap-3 rounded-lg text-white">
              ...
              <span><strong className="block font-display text-xl">Helping Tribe</strong><span className="text-[10px] font-bold uppercase tracking-[0.16em] text-slate-400">Academy</span></span>
            </Link>
            <p className="mt-6 text-sm leading-[1.65] text-slate-400">A calm, structured learning community for ethical counselling and positive psychology practice.</p>
          </div>
          <div>
            <h2 className="text-[0.7rem] font-bold uppercase tracking-[0.16em] text-white/90">Explore</h2>
          ...
          <div>
            <h2 className="text-[0.7rem] font-bold uppercase tracking-[0.16em] text-white/90">Access</h2>
          ...
          <div>
            <h2 className="text-[0.7rem] font-bold uppercase tracking-[0.16em] text-white/90">Contact</h2>
