      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1">
            Create quizzes and set correct answers. Learners see published quizzes once; answers are locked after submit.
          </p>
        </div>
      ...
      <Card className="p-4 border-slate-200">
        {loading ? (
          ...
          <p className="text-sm text-slate-500 py-6">
            No quizzes yet. Add a quiz, then add questions and set the correct answer for each. Publish to show to learners.
          </p>
        ) : (
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                aria-label="Published (visible to learners)"
              />
              <Label htmlFor="quiz-published">Published (visible to learners)</Label>
            </div>
