    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1">
            Manage discussion prompts by module. Learners and mentors see these on the forum; add or edit prompts here so &quot;No discussion prompts yet&quot; is fixable without touching the DB.
          </p>
        </div>
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <p className="text-sm text-slate-500 py-6">
              No discussion prompts yet. Add one to show it on the learner and mentor forum.
            </p>
          ) : (
      ...
      <Card className="border-slate-200">
        <CardHeader>
          ...
          <CardDescription>
            How learners and mentors see the discussion forum.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <DiscussionForum />
